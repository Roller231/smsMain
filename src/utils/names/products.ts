...
export const searchItems = {
  ...
  vm: 'okcupidokcupid',
  fr: 'danadana',
  xj: 'купер,kyper,regth,megamarket,market,мегамаркет,маркет',
  df: 'happnhappn',
  ...
  atu: 'Сбер,sber,c,th,сберайди,айди,id,cber,купер,kyper,regth,megamarket,market,мегамаркет,маркет',
  aug: 'Magnit,ьфптше,магнит,ьфклуе,vauybn',
  aeg: 'Flowwow,адщццщц,адщц,flow',
  ady: 'ТОКИО-CITY,tokio-city,city,tokio,токио,ещлшщ,сшен',
  auf: 'PREMIER,зкуьшук,зкууууь,ghtvmth,премьер',
  bde: 'шаверно,ырмуктщ,ifdthyj,шаурма,шуш',
  ail: 'cмотрёшка,сморт,смотрешка,сматрешка,cvfnhtirf,cvjnhtirf,cvfnhtierf',
  bcf: 'hoff,хофф,рщаа',
  bcg: '2ГИС,ldfubc,ubc,гис',
  akf: 'ollis,щддшы',
  ato: 'Podrygka,подружка,зщвкнплф',
  btu: 'DDX Fitness,ввчашдтуыы,abnytc,фитнес,ддх',
  mf: 'Weidian,цувшфт,ведиан',
  blc: 'Дикси,lbrcb',
  bpf: 'Fix Price,фикс прайс',
  bwy: 'Монетка,vjytnrf,vjytnf,монета',
  aoh: 'ЮMoney,деньги,ymoney,юьщтун,юмоней',
};
...
export function mapServiceTitle<T extends SMSServices>(
  ...
  return value
    .map((item) => {
      ...
      const name = products[item.name]?.toString() || item.name;

      item.longName = dataStore.isSaved
        ? replaceLettersWithNumbers(name)
        : name;
      return item;
    })
